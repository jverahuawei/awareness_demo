    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.add_locationBarrier_stay:
                @SuppressLint("MissingPermission") AwarenessBarrier stayBarrier = LocationBarrier.stay(latitude, longitude, radius, mTimeOfDuration);
                Utils.addBarrier(this, STAY_BARRIER_LABEL, stayBarrier, mPendingIntent);
                break;
            case R.id.add_locationBarrier_exit:
                @SuppressLint("MissingPermission") AwarenessBarrier exitBarrier = LocationBarrier.exit(latitude, longitude, radius);
